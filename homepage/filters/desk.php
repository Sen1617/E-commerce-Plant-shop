<h1 class="heading">DESK PLANTS</h1>

    <div class="box-container">
    <div class="pl1">
       <div class="box">
			<span class="discount">-10%</span>
			<img src="products/desk1.jpg" alt="">
			<h3>Swiss cheese plant</h3>
			<div class="quantity">
				<span> quantity : </span>
				<input class="quan" type="number" min="1" max="100" value="1">
			</div>
    ...
    <div class="box">
        ...
        <img src="products/desk2.jpg" alt="">
    ...
    <div class="box">
        ...
        <img src="products/desk3.jpg" alt="">
    ...
    <div class="box">
        ...
        <img src="products/desk4.jpg" alt="">
        <h3>Spider Plant</h3> 
        <div class="quantity">
            <span> quantity : </span>
            <input class="quan" type="number" min="1" max="100" value="1">
    ...
    <div class="box">
        ...
        <img src="products/desk5.jpg" alt="">
    ...
    <div class="box">
        ...
        <img src="products/desk6.jpg" alt="">
